! function(e, t) {
    ...
    return function() {
        ...
        return function() {
            ...
            var b = function(e) {
                ...
                return d(i, [{
                            ...
                            if (e[0].upload.chunked) {
                                ...
                                if (o.upload.finishedChunkUpload = function(n) {
                                        ...
                                        for (var a = 0; a < o.upload.totalChunkCount; a++) {
                                            ...
                                            o.upload.chunks[a].status !== i.SUCCESS && (r = !1)
                                        }
                                        r && t.options.chunksUploaded(o, (function() {
                                            t._finished(e, "", null)
                                        }))
                    ...
                    value: function(e, t) {
                        ...
                        o.open(u, s, !0), o.timeout = this.resolveOption(this.options.timeout, e), o.withCredentials = !!this.options.withCredentials, o.onload = function(t) {
                    ...
                    value: function(e, t, n) {
                        ...
                        if (void 0 !== n) {
                            if (r = 100 * n.loaded / n.total, e[0].upload.chunked) {
                                ...
                                o.progress = r, o.total = n.total, o.bytesSent = n.loaded, i.upload.progress = 0, i.upload.total = 0, i.upload.bytesSent = 0;
            ...
            b.initClass(), b.version = "5.8.1", b.options = {}, b.optionsForElement = function(e) {
