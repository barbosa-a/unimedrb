...
$SendCadPersonalizacao = filter_input(INPUT_POST, 'SendCadPersonalizacao', FILTER_DEFAULT);

if($SendCadPersonalizacao){
    $nome_sistema    = filter_input(INPUT_POST, 'nome_sistema', FILTER_DEFAULT);
    $site            = filter_input(INPUT_POST, 'site', FILTER_DEFAULT);
    ...
    //verificar se existe registro na tabela personalizacao_sistema
    if (($query_cons_dados_sistema) AND ($query_cons_dados_sistema->num_rows != 0)) {
        ...
        if (isset($_FILES['arquivo']['name']) && $_FILES['arquivo']['error'] == 0) {        
            ...
            if (strstr('.jpg;.jpeg;.gif;.png', $extensao)) {
                ...
                $destino = 'dist/img/' . $novoNome;

                // tenta mover o arquivo para o destino
                if (move_uploaded_file($arquivo_tmp, $destino)) {
                    //salvar no banco
                    $cad_conteudo = "UPDATE personalizacao_sistema SET
                        nome_sistema = '$nome_sistema',
                        site_sistema = '$site', 
                        nome_empresa = '$empresa', 
                        versao_atual_sistema = '$versao', 
                        logo_sistema = '$novoNome', 
                        usuario_id = '".$_SESSION['usuarioID']."',
                        modificado = NOW()";
                    $query_conteudo = mysqli_query($conn, $cad_conteudo);
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p class="text-left">
                                            Dados da logo enviado <br>
                                            Arquivo: <strong>' . $_FILES['arquivo']['name'] . '</strong><br />
                                            Tipo: <strong > ' . $_FILES['arquivo']['type'] . ' </strong ><br />
                                            Tamanho: <strong>' . $_FILES['arquivo']['size'] . 'Bytes</strong> 
                                        </p>
                                    </div>
                        ...
                        <div class="modal fade" id="procmsg" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-sm">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <p class="text-center">Erro ao atualizar, tente novamente.</p>
        ...
        if (isset($_FILES['arquivo']['name']) && $_FILES['arquivo']['error'] == 0) {        
            ...
            if (strstr('.jpg;.jpeg;.gif;.png', $extensao)) {
                ...
                if (move_uploaded_file($arquivo_tmp, $destino)) {
                    //salvar no banco
                    $cad_conteudo = "INSERT INTO
                            personalizacao_sistema
                        (nome_sistema, site_sistema, nome_empresa, versao_atual_sistema, logo_sistema, criado) 
                            VALUES 
                        ('$nome_sistema', '$site', '$empresa', '$versao', '$novoNome', NOW())";
                    $query_conteudo = mysqli_query($conn, $cad_conteudo);
            ...
            $cad_conteudo = "INSERT INTO
                personalizacao_sistema
                (nome_sistema, site_sistema, nome_empresa, versao_atual_sistema, criado) 
                    VALUES 
                ('$nome_sistema', '$site', '$empresa', '$versao', NOW())";
            $query_conteudo = mysqli_query($conn, $cad_conteudo);
            if (mysqli_insert_id($conn)) {
                $_SESSION['msg'] = '
                    <div class="modal fade" id="procmsg" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
