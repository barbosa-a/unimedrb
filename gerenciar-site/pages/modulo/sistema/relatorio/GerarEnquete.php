  ...
  <body>
	...
	<div class="col-lg-8 mx-auto p-3 py-md-5">
	  ...
	  <main>
		...
		<h3 class="text-center mb-5">Resultado da avaliação <br><small class="text-muted">Pontuação</small></h3>
	    <table class="table">
		  <tbody>
		  	<?php foreach (PesquisarEnquete($conn, $contrato, $dataInicioEnquete, $dataFimEnquete) as $enquete) { ?>
		  		<tr>
			      <th scope="row"><?php echo $enquete['nome'] ?></th>
			      <td><?php echo $enquete['total']; ?></td>
			    </tr>
		  	<?php } ?>	    
		  </tbody>
		</table>
