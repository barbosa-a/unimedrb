...
$dir = "../backup/sistema/"; // Substitua pelo caminho do diretório que você deseja listar
$linhasDir = 1;
...
if (is_dir($dir)) {
    ...
    foreach ($files as $file) { ?>
        <tr>
            ...
            <td>
                <a href="<?php echo "sistema/" . $dir . $file; ?>" download class="mr-2">
                    <i class="fa fa-download" aria-hidden="true"></i>
                </a>
                <a href="#" onclick="excluirBkpSys('<?php echo $file; ?>')">
