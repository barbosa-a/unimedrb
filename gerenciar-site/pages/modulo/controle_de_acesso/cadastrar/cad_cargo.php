...
<div class="content">
  <div class="container-fluid">
    <div class="card card-primary card-outline">
          ...
          <div class="card-body">
            <form method="POST" action="<?php echo pg; ?>/pages/modulo/controle_de_acesso/cadastrar/processa/proc_cad_cargo" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="Nome do grupo">Nome</label>
                    <input type="text" class="form-control" name="nome_cargo" required="" autofocus="" autocomplete="off" placeholder="Nome do cargo" >
                </div>
                <div class="form-group">
                    <label for="Nome do grupo">Departamento</label>
                    <select class="form-control" name="departamento" required="">
                        <option value="">Selecione</option>
                        <?php echo ListarDepartamentosCargos($conn); ?>
                    </select>
                </div>
                
                <div class="form-group">
                    <label for="descrição do grupo">Descrição</label>
                    <textarea class="form-control" name="descricao_cargo" placeholder="Descrição" rows="3"></textarea>
                </div>
                <input type="submit" class="btn btn-primary" name="sendCadastraCargo" value="Salvar">
