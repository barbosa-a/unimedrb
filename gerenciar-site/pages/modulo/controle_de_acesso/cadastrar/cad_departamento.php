...
<div class="content">
  <div class="container-fluid">
    <div class="card card-primary card-outline">
          ...
          <div class="card-body">
            <form method="POST" action="<?php echo pg; ?>/pages/modulo/controle_de_acesso/cadastrar/processa/proc_cad_departamento" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="Nome do departamento">Nome</label>
                    <input type="text" class="form-control" name="nome_depar" required="" autofocus="" autocomplete="off" placeholder="Nome do departamento">
                </div>
                <div class="form-group">
                    <label for="descrição do departamento">Descrição</label>
                    <textarea class="form-control" name="descricao_depar" placeholder="Descrição" rows="3"></textarea>
                </div>
                <input type="submit" class="btn btn-primary" name="sendCadastraDepartamento" value="Salvar">
