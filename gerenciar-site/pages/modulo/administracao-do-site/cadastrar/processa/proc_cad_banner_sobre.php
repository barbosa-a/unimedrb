  ...
  if (isset($_FILES['arquivo']['name'])) {
    ...
    //O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta foto
        ...
        try {
            ...
            // Pasta
            $pasta = "/dist/storage/sobre/$nome_final";
            ...
            if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta']. $nome_final)){
                ...
                $cons_banner = "SELECT MAX(ordem) AS ordem_atual FROM site_sobre_img";
                ...
                $cad = "INSERT INTO site_sobre_img 
                        (titulo, transicao, arquivo, obs, ordem, usuario_id, created) 
                            VALUES
                        ('{$dado['titulo']}', '{$transicao}', '{$pasta}', '{$dado['desc']}', '{$ordem}', '{$_SESSION['usuarioID']}', NOW())
                ";                
